...
def generate_coco_annotations(train_dir, output_path):
    folder_names = sorted([f for f in os.listdir(train_dir) if os.path.isdir(os.path.join(train_dir, f))])
    images = []
    annotations = []
...
coco_format_data = generate_coco_annotations(directory_path, output_path)
