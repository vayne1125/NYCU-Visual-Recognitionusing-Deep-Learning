...
def _get_fc_layer(version, num_ftrs, class_number):
    ...
    """
    if version == 0:
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b32_e100_v4
    ...
    if version == 1:
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b32_e100_v1
        # resneXt50_w_imagenet1K2V_drop0.25_lrdynimc_b32_e100 d = 0.25
        # resneXt101_w_imagenet1K2V_drop0.5_lrdynimc_b64_e100
        return nn.Sequential(
    ...
    if version == 2:
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b32_e100_v2
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b32_e120
        return nn.Sequential(
    ...
    if version == 3:
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b32_e100
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b64_e100
        return nn.Sequential(
            nn.Linear(num_ftrs, 512),
            nn.BatchNorm1d(512),
            nn.ReLU(),
    ...
    if version == 4:
        # resneXt50_w_imagenet1K2V_drop0.5_lrdynimc_b32_e100_v3
        return nn.Sequential(
            nn.Linear(num_ftrs, 500),
    ...
    if version == 5:
        # resneXt101_w_imagenet1K2V_drop0.5_lrdynimc_b64_e100_v1
        return nn.Sequential(
            nn.Linear(num_ftrs, 512),
